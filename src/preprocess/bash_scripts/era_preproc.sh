...
BREAK
        ...
        ncatted -a standard_name,rh,o,c,"relative_humidity" ${Intermediate_File_Directory}/rh_era5_date_${d}_time_${t}.nc ${Intermediate_File_Directory}/rh_era5_date_${d}_time_${t}.nc # set standard name according to cf con$

        # 3. Interpolate to 0.25x0.25 grid
        cdo -f nc -sellonlatbox,-180,180,-90,90 -random,r1440x720 template.nc # create target grid
        cdo -remapcon,template.nc ${Intermediate_File_Directory}/rh_era5_date_${d}_time_${t}.nc ${Intermediate_File_Directory}/rh_remap_era5_date_${d}_time_${t}.nc # rh is extensive variable: conservative interp
        ...
        cdo sellonlatbox,$MIN_LON,$MAX_LON,$MIN_LAT,$MAX_LAT ${Intermediate_File_Directory}/remap_era5_date_2016_07_01_time_00_00_00.nc ${Intermediate_File_Directory}/sellatlon_era5_date_${d}_time_${t}.nc
